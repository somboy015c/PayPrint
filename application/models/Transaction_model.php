...
class Transaction_model extends CI_Model
{
    ...
    //get transactions count
    public function get_unpaid_transactions_count()
    {
    ...
    //set transactions paid
    public function set_promoted_transaction_paid($id)
    {
        $data['payment_status'] = 'payment_completed';
        $this->db->where('id', $id);
        $this->db->update('promoted_transactions', $data);
    }
    ...
    //get promoted requests count
    public function get_promoted_requests_count()
    {
        $this->db->where('payment_status', 'awaiting_payment');
        $query = $this->db->get('promoted_transactions');
        return $query->num_rows();
