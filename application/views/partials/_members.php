                                ...
                                <div class="member-list-item" style="min-height: 138px;display: table;width: 100%;padding: 5px 5px 5px;box-sizing: border-box;color: #676b6d;font-size: 14px;line-height: 19px;border: 1px solid rgba(182, 180, 180, .25);background: #fff;color: #676b6d;transition: box-shadow 0.25s ease;margin-bottom: 18px;box-shadow: 0px 1px 5px 0px rgba(210, 200, 200, .5); border-radius: 6px;">
                                    ...
                                    <div class="row-custom pdp" style="padding-left: 10px; padding-right: 10px;">
                                        <div class="row-custom">
                                            <label class="" style="font-size: 18px; margin: 0px;"><p class="username" style=" margin: 0px; color: black;"><?php $num_len = strlen(get_shop_name($member)); if ($num_len > 30) {
                                            echo substr(get_shop_name($member), 0, 29) . "..";
                                        ...
                                        <div class="row-custom">
                                            ...
                                            <div class="" style="float: right;">
                                               <p  style=" font-size: 13px;margin-bottom: 3px;margin-top: 6px;"><span class="info"><i class="icon-map-marker"></i>&nbsp;<?php $num_len = strlen(get_location($member)); if ($num_len > 31) {
                                            echo substr(get_location($member), 0, 30) . "..";}else { echo get_location($member); } ?></span></p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row-custom">
                                            ...
                                            <p  style=" font-size: 13px;margin-bottom: 7px;margin-top: 5px;"><?php $num_len = strlen($member->about_me); if ($num_len > 56) {
                                            echo substr(html_escape($member->about_me), 0, 55) . "..";}else { echo html_escape($member->about_me); } ?></p>
                                        </div>
                                    </div>
