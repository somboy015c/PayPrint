...
<!--featured categories-->
<div class="col-12 row featured-categories" style="margin-top: 15px; margin-bottom: 15px;">
    <div class="col-3">
        <?php $f_cat_1 = get_featured_category(1); ?>
        <?php if (!empty($f_cat_1)): ?>
            <div class="featured-category">
                <div class="inner" style=" border-radius: 24px;">
                    <a href="<?php echo generate_category_url($f_cat_1) . '?drls=cat'; ?>">
                        <img src="<?php echo $img_bg_product_small; ?>" data-src="<?php echo get_category_image_url($f_cat_1, 'image_1'); ?>" alt="<?php echo html_escape($f_cat_1->name); ?>" class="lazyload img-fluid" onerror="this.src='<?php echo $img_bg_product_small; ?>'">
