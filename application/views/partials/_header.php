...
<head>
	...
	<meta property="og:site_name" content="<?php echo xss_clean($general_settings->application_name); ?>"/>
...
<?php endforeach; endif; ?>
	...
	<meta name="twitter:site" content="@<?php echo xss_clean($general_settings->application_name); ?>"/>
...
.header-top, .header-bottom {
    ...
    text-align: center;}">
	<div class="main-menu">
		<div class="container-fluid" style="background-color: #f86923 !important; width: 100%;">
			<div class="row">
				<div class="nav-top">
					<div class="container">
						<div class="row align-items-center">
							...
							<div class="col-md-7 nav-top-left" style="margin: 0px; padding: 0px;">
								<div class="row-align-items-center">
									<div class="logo">
										<a href="<?php echo lang_base_url(); ?>" style="font-size: 0px;"><img src="<?php echo get_logo($general_settings); ?>" alt="logo" class="igm"></a>
									</div>
									...
									<div class="top-search-bar">
										...
										<div class="left">
											<div class="dropdown search-select">
												<button type="button" class="btn" data-toggle="dropdown" style="padding: 5px 0px 5px 15px;">
													<img src="<?php echo lang_base_url(); ?>assets/img/carrrf.png" style="width: 83.75%;">
												</button>
											</div>
											<input type="hidden" class="search_type_input" name="search_type" value="Tc">
										</div>
										<div class="right">
											<input type="text" name="search" maxlength="300" pattern=".*\S+.*" id="input_search" class="form-control input-search" value="<?php echo  (!empty($filter_search)) ? $filter_search : ''; ?>" placeholder="<?php echo ("Search for transportation station"); ?>" required autocomplete="off">
							...
							<div class="col-md-5 nav-top-right" style="margin: 0px; padding: 0px;">
								<ul class="nav align-items-center">
									<?php if (is_sale_active()): ?>
										<li class="nav-item nav-item-cart li-main-nav-right">
											<a href="<?php echo lang_base_url(); ?>cart" class="pad">
												<i class="icon-price-tag-o"></i><span><?php echo ("Bookings"); ?></span>
									...
									<?php if ($this->auth_check): ?>
										<li class="nav-item li-main-nav-right">
											<a href="<?php echo lang_base_url(); ?>favorites/<?php echo $this->auth_user->slug; ?>" class="pad">
												<i class="icon-heart-o"></i><?php echo trans("favorites"); ?>
											</a>
										</li>
									<?php else: ?>
										<li class="nav-item li-main-nav-right">
											<a href="<?php echo lang_base_url(); ?>favorites" class="pad">
												<i class="icon-heart-o"></i><?php echo trans("favorites"); ?>
											</a>
										</li>
									<?php endif; ?>
									...
									<?php if (auth_check()): ?>
										<li class="dropdown profile-dropdown">
											<a class="dropdown-toggle a-profile pad" data-toggle="dropdown" href="javascript:void(0)"
											   aria-expanded="false">
												<?php if ($unread_notifications_count > 0): ?>
													<span class="notification"><?php echo $unread_notifications_count; ?></span>
												<?php endif; ?>
												<img src="<?php echo get_user_avatar($this->auth_user); ?>" alt="<?php echo $this->auth_user->username; ?>">
												<span class="username"><?php $num_len = strlen($this->auth_user->username); if ($num_len > 5) {
                                            echo substr($this->auth_user->username, 0, 4) . "..";
                                            } else { echo $this->auth_user->username;} ?></span>
											...
											<ul class="dropdown-menu">
														...
														<li>
															<a href="<?php echo lang_base_url(); ?>profile/<?php echo $this->auth_user->slug; ?>">
																...
																<?php else: ?>
																	<img src="<?php echo base_url(); ?>assets/img/station.png" style="height: 18px; width: 20px;"><?php echo ("&nbsp;Visit&nbsp;Station"); ?>
																<?php endif; ?>
															</a>
														</li>
														<?php if (is_sale_active()): ?>
															...
															<?php if (is_user_vendor()): ?>
																...
																<li>
																	<a href="<?php echo lang_base_url(); ?>earnings?type=forcasts">
																		<img src="<?php echo base_url(); ?>assets/img/analytics.png" style="height: 16px; width: 18px;">
																		<?php echo ("&nbsp;Analytics"); ?>
															...
															<?php if (is_bidding_system_active()): ?>
																<li>
																	<a href="<?php echo lang_base_url(); ?>quote-requests">
																		<img src="<?php echo base_url(); ?>assets/img/rideshare2.png" style="height: 14px; width: 18px;">
										...
										<?php if (is_multi_vendor_active()): ?>
											...
											<li class="nav-item"><a href="<?php echo lang_base_url(); ?>sell-now?pt=forsale" class="btn btn-md btn-custom btn-sell-now pad"><?php echo ("Ride&nbsp;Share"); ?></a></li>
											<?php else: ?>
											<li class="nav-item"><a href="<?php echo lang_base_url(); ?>sell-now" class="btn btn-md btn-custom btn-sell-now pad"><?php echo ("Ride&nbsp;Share"); ?></a></li>
											<?php endif; ?>
										<?php endif; ?>
									<?php else: ?>
										<li class="nav-item"><a href="javascript:void(0)" data-toggle="modal" data-target="#loginModal" class="pad"><?php echo trans("login"); ?></a></li>
										<li class="nav-item"><a href="<?php echo lang_base_url(); ?>register" class="pad"><?php echo trans("register"); ?></a></li>
										<?php if (is_multi_vendor_active()): ?>
											<li class="nav-item"><a href="<?php echo lang_base_url(); ?>register" class="btn btn-md btn-custom btn-sell-now pad"><?php echo ("Ride&nbsp;Share"); ?></a></li>
										<?php endif; ?>
									<?php endif; ?>
								</ul>
				...
				<div class="nav-main">
					...
					<center>
						<div class="row">
							...
							<div class="col-md-1" style="padding-top: 7px; padding-left: 0px;padding-right: 0px;">
									...
									<div class="region-right">
										<div class="row-custom footer-location">
											...
											<div class="icon-text">
												...
												<button type="button" class="btn btn-primary dropdown-toggle bn-lg" data-toggle="modal" data-target="#locationModal" style="min-width: 0px; min-height: 0px; text-align: left; width: unset;">
													<?php if ($num_len > 8) {echo substr($default_state, 0, 7) . "..";} else { echo $default_state;} ?><span class="icon-arrow-down"></span>
												</button>
												<button type="button" class="btn btn-primary dropdown-toggle bn-md" data-toggle="modal" data-target="#locationModal" style="font-size: 12px; min-width: 0px; min-height: 0px; text-align: left; width: unset;">
													<?php if ($num_len > 8) {echo substr($default_state, 0, 7) . "..";} else { echo $default_state;} ?><span class="icon-arrow-down"></span>
												</button>
											</div>
										</div>
	...
	<div class="mobile-menu" style="padding: 0px; margin: 0px;transition: all 300ms ease;
    -moz-transition: all 300ms ease;
    -ms-transition: all 300ms ease;
    -o-transition: all 300ms ease;
    animation: 0.9s ease 0s running fixedAnim;
				...
				<div class="col-12 p-0">
					<div class="mobile-header">
						<div class="mobile-header-item mobile-header-item-icon">
							<a href="<?php echo lang_base_url(); ?>" class="mobile-logo"><img src="<?php echo get_favicon($general_settings); ?>" alt="logo" style="padding: 8px;"></a>
						</div>
						<div class="mobile-header-item mobile-header-item-logo">
							


							<div class="top-search-bar mobile-search-form" style="margin: 0px; padding: 0px;">
								<?php echo form_open(lang_base_url() . 'search', ['id' => 'form_validate_search_mobile', 'method' => 'get']); ?>
									<div class="left" style="min-width: 10px;">
										<div class="dropdown search-select" style="min-width: 55px;">
											<button type="button" class="dropdown-toggle" data-toggle="dropdown" style="border-top-left-radius: 15px; border-bottom-left-radius: 15px; min-width: 10px; padding: 8px;" id="button">
													<img src="<?php echo lang_base_url(); ?>assets/img/carrrf.png" style="width: 100%; ">
											</button>
										</div>
										<input type="hidden" class="search_type_input" name="search_type" value="Tc">
									</div>
									<div class="right">
										<input type="text" name="search" maxlength="300" pattern=".*\S+.*" id="input_search" class="form-control input-search" value="<?php echo  (!empty($filter_search)) ? $filter_search : ''; ?>" placeholder="<?php echo ("Search for transportation station"); ?>" required autocomplete="off" style="border-top-right-radius: 15px !important; border-bottom-right-radius: 15px !important;">
										<button class="btn btn-default btn-search"><i class="icon-search"></i></button>
										<div id="response_search_results" class="search-results-ajax"></div>
									</div>
								<?php echo form_close(); ?>
						...
						<div class="mobile-header-item mobile-header-item-icon">
							<?php if (is_sale_active()): ?>
								<div class="cart-icon-mobile">
									<a href="<?php echo lang_base_url(); ?>cart" class="cart-link-mobile"><i class="icon-price-tag-o"></i>
										<?php $cart_product_count = get_cart_product_count(); ?>
										<span class="notification"><?php echo $cart_product_count; ?></span>
									</a>
								</div>
...
<?php $t = $this->session->flashdata("security"); if ($t) { echo ' <script> $(document).ready(function () { var message = "' .$t.'"; swal({ text: message, buttons: sweetalert_ok, dangerMode: true, }); }); </script> ';} $this->session->set_flashdata('security', ("")); ?>
</header>
			...
			<div class="modal-content">
				<div class="auth-box">
					...
					<form id="form_login" novalidate="novalidate">
						...
						<div class="form-group text-right" style="line-height: 20px;">
						...
						<center><label>Or register with:</label></center>
						<div class="social-login-cnt"><center>
							<?php $this->load->view("partials/_social_login", ["or_text" => trans("login_with_email")]); ?></center>
						</div>
...
<?php endif; ?>
	...
	<!-- Location Modal -->
	<div class="modal fade" id="locationModal" style="z-index: 999999">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-12 col-sm-12 m-b-15">
                                    <div class="selectdiv">
                                    	<select id="countries_m" name="country_id" class="form-control" onchange="get_states_m(this.value);" required>
			                                <option value=""><?php echo trans('country'); ?></option>
			                                <?php foreach ($countries_m as $item): ?>
			                                    <option value="<?php echo $item->id; ?>" <?php echo ($item->id == $country_id_m) ? 'selected' : ''; ?>><?php echo html_escape($item->name); ?></option>
			                                <?php endforeach; ?>
			                            </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-sm-12 m-b-15">
                                    <div class="selectdiv">
                                        <select id="states_m" name="state_id" class="form-control" onchange="get_cities_m(this.value);" required>
			                                <option value=""><?php echo trans('state'); ?></option>
			                                <?php
			                                if (!empty($states_m)):
			                                    foreach ($states_m as $item): ?>
			                                        <option value="<?php echo $item->id; ?>" <?php echo ($item->id == $state_id_m) ? 'selected' : ''; ?>><?php echo html_escape($item->name); ?></option>
			                                    <?php endforeach;
			                                endif; ?>
			                            </select>
                                    </div>
                                ...
                                <div class="col-12 col-sm-12 m-b-15">
                                    <div class="selectdiv">
                                        <select id="cities_m" name="city_id" class="form-control" required>
			                                <option value=""><?php echo ('City / L.G.A'); ?></option>
			                                <?php
			                                if (!empty($cities_m)):
			                                    foreach ($cities_m as $item): ?>
			                                        <option value="<?php echo $item->id; ?>" <?php echo ($item->id == $city_id_m) ? 'selected' : ''; ?>><?php echo html_escape($item->name); ?></option>
			                                    <?php endforeach;
			                                endif; ?>
			                            </select>
                                    </div>
...
<br/><br/><br/><br/><div class="main-menu"><br/><br/></div><div class="mobile-menu" style="padding: 4px;"></div>
