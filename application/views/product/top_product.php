				...
				<nav class="nav-breadcrumb" aria-label="breadcrumb">
					<ol class="breadcrumb breadcrumb-products">
						...
						<?php if (!empty($category)):
							...
							<li class="breadcrumb-item active" aria-current="page"><?php echo ("Top products"); ?></li>
						<?php endif; ?>
					</ol>
				</nav>
			</div>
			...
			<div class="col-12 col-md-9">
				...
				<div class="product-list-content">
					<div class="row row-product">
						<!--print products-->
						<?php foreach ($latest_products as $product): $rew_count = $this->review_model->get_review_count($product->id); $userrole = get_user($product->user_id)->role;?>
							<?php if ($userrole == "vendor" && $rew_count > 0): ?>
							<div class="col-6 col-sm-6 col-md-6 col-lg-4 col-product">
								<?php $this->load->view('product/_product_item', ['product' => $product, 'promoted_badge' => true]); ?>
							</div>
						<?php endif; ?>
						<?php endforeach; ?>
						<?php if (empty($latest_products) && $rew_count = 0): ?>
							<div class="col-12">
