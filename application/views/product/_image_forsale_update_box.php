...
<p class="images-exp"><i class="icon-exclamation-circle"></i><?php if ($bully == 'work'){ echo ("Works with good and clear images sells faster!"); }else{ echo trans("product_image_exp"); } ?></p>
