                                            ...
                                            <div class="col-12 col-md-12 col-lg-11">
												...
												<div class="row">
													<div class="col-12 m-b-30">
														<label class="control-label font-600"><?php echo ("Service&nbsp;Galery"); ?></label><span>&nbsp;(Optional)</span>
                                                    ...
                                                    <div class="col-12">
                                                                        ...
                                                                        <div class="row">
                                                                            <?php if ($general_settings->classified_ads_system == 1): ?>
                                                                                <div class="col-12 col-sm-6 col-option listing_ordinary_listing">
                                                                                    <div class="custom-control custom-radio">
                                                                                        <input type="radio" name="listing_type" value="ordinary_listing" id="listing_type_2" class="custom-control-input" checked required>
                                                        ...
                                                        <div class="form-box">
                                                            ...
                                                            <div class="form-group" style="display: none;">
                                                                ...
                                                                <input type="text" name="title" class="form-control form-input" value="Transportation" placeholder="<?php echo trans("title"); ?>" required>
                                                            </div>
                                                            <div class="form-box-body">
                                                                <div class="form-group">
                                                                    <label class="control-label"><?php echo ("Bus&nbsp;Station"); ?></label>
                                                                    <div class="selectdiv">
					                                                    <select name="branch" class="form-control" id="station" required>
					                                                        <option value=""><?php echo ('Select&nbsp;Your&nbsp;Service&nbsp;Branch'); ?></option>
					                                                        <?php
					                                                        if (!empty($stations)):
					                                                            foreach ($stations as $item): ?>
					                                                                <option value="<?php echo html_escape($item->branch_state_id); ?>"><?php echo html_escape($item->branch); ?></option>
					                                                            <?php endforeach;
					                                                        endif; ?>
					                                                    </select>
					                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="selectdiv">
					                                                    <select name="destination" class="form-control" onchange="set_within(this.value);" required>
					                                                        <option value=""><?php echo ('Select Service Destination'); ?></option>
					                                                        <?php
					                                                        if (!empty($states)):
					                                                            foreach ($states as $item): ?>
					                                                                <option value="<?php echo html_escape($item->id); ?>"><?php echo html_escape($item->name) . ' State'; ?></option>
					                                                            <?php endforeach;
					                                                        endif; ?>
					                                                    </select>
					                                                </div>
                                                        ...
                                                        <div class="form-box" id="within">
                                                            <div class="form-box-body">
                                                                <div class="form-group">
                                                                    <div class="row">
                                                                        <p class="images-exp" style="padding-bottom: 15px;"><i class="icon-exclamation-circle"></i>You are registering a transportation service operating within a state, please specify the exact location and destination name or landmark.</p>
                                                                        <div class="col-12 col-sm-6 m-b-sm-15">
                                                                            <label class="control-label"><?php echo ("Take-Off Location"); ?></label>
                                                                            <input type="text" name="address" class="form-control form-input" value="" placeholder="<?php echo ("Type the take-off location in ") . $default_state . ' State'; ?>" required>
                                                                        </div>

                                                                        <div class="col-12 col-sm-6 m-b-sm-15">
                                                                            <label class="control-label"><?php echo ("Exact Destination"); ?></label>
                                                                            <input type="text" name="zip_code" class="form-control form-input" value="" placeholder="<?php echo ("Type the exact destination in ") . $default_state . ' State'; ?>">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="form-box">
                                                            <div class="form-box-body">
                                                                <div class="form-group">
                                                                    <label class="control-label"><?php echo ("Vehicle&nbsp;Type"); ?></label>
                                                                    <div class="selectdiv">
														...
														<input type="hidden" name="bully" value="work">
                                                        <input type="hidden" name="qty_scale" value="<?php echo 1; ?>">
                                                        <input type="hidden" name="forsale" value="<?php echo 0; ?>">
                                                        <div class="form-group">
...
<script>
    $('#within').hide();
    function set_within(within_id) {
        var stat_id = $('#station').val();
        if (within_id == stat_id) {
            $('#within').show();
        }
    }
