							...
							<div class="col-12 col-md-12 col-lg-11">
								...
								<div class="row">
									<div class="col-12">
												...
												<div class="form-box-body">
													<div class="form-group">
														<div class="row">
															...
															<?php endif; ?>
															<?php if ($general_settings->digital_products_system == 1 && $product->for_sale != 1): ?>
																<div class="col-12 col-sm-6 col-option">
																	<div class="custom-control custom-radio">
												...
												<div class="form-box-body">
													<div class="form-group">
														<div class="row">
															...
															<?php endif; ?>
															<?php if ($general_settings->classified_ads_system == 1 && $product->for_sale != 1): ?>
                                                                        ...
                                                                        <select name="branch" class="form-control" required>
                                                                            ...
                                                                            if (!empty($stations)):
                                                                                foreach ($stations as $item): ?>
                                                                                    <option value="<?php echo html_escape($item->branch_state_id); ?>" <?php echo ($item->branch_state_id == $product->service_branch_id) ? 'selected' : ''; ?>><?php echo html_escape($item->branch); ?></option>
                                                                                <?php endforeach;
                                                                            endif; ?>
                                                                        </select>
                                                                    </div>
                                                                        ...
                                                                        <select name="destination" class="form-control" required>
                                                                            ...
                                                                            if (!empty($states)):
                                                                                foreach ($states as $item): ?>
                                                                                    <option value="<?php echo html_escape($item->id); ?>" <?php echo ($item->id == $product->service_destination_id) ? 'selected' : ''; ?>><?php echo html_escape($item->name) . ' State'; ?></option>
                                                                                <?php endforeach;
                                                                            endif; ?>
                                                                        </select>
                                                                    </div>
                                                                        ...
                                                                        <select id="categories" name="category_id_0" class="form-control" onchange="get_subcategories(this.value, 0);" required>
                                                                            ...
                                                                            <?php if (!empty($parent_categories)):
                                                                                foreach ($parent_categories as $item): ?>
                                                                                    <option value="<?php echo html_escape($item->id); ?>" <?php echo ($item->id == $product->category_id) ? 'selected' : ''; ?>><?php echo html_escape(get_category_name_by_lang($item->id, $this->selected_lang->id)); ?></option>
                                                                                <?php endforeach;
                                                                            endif; ?>
                                                                        </select>
                                                                    </div>
										...
										<?php if ($product->is_draft != 1): ?>
											<div class="form-box" style="<?php if (!is_admin()) {echo "display: none;";} ?>">
												<div class="form-box-head">
