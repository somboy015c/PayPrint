	...
	<div class="container">
		<div class="row">
			<div id="content" class="col-12">
				...
				<h1 class="page-title page-title-product m-b-15"><?php echo ("Workshop Opening Request"); ?></h1>
				<div class="form-add-product">
					<div class="row justify-content-center">
						<div class="col-12 col-md-12 col-lg-10">
							<div class="row">
								<div class="col-12">
									<p class="start-selling-description"><?php echo ("In order to open a workshop, you must be a verified member. fill in the bellow form carefully and wait for admin aproval."); ?></p>
								</div>
							</div>
							<div class="row">
								<div class="col-12">
								...
								<div class="row">
									<div class="col-12">
										<div class="alert alert-secondary" role="alert">
											<?php echo ("You have an active shop Opening request on processing.!"); ?>
										</div>
									</div>
								</div>
							<?php endif; ?>
							<?php if ($this->auth_check):
								if ($this->auth_user->is_active_workshop_request == 1):?>
									<div class="row">
										<div class="col-12">
								...
								<?php elseif ($this->auth_user->is_active_workshop_request == 2): ?>
									<div class="row">
										<div class="col-12">
											<div class="alert alert-secondary" role="alert">
								...
								<?php elseif ($this->auth_user->is_active_workshop_request != 1 && $this->auth_user->is_active_workshop_request != 2 && $this->auth_user->is_active_shop_request != 1): ?>
									<div class="row">
										<div class="col-12">
											...
											<div class="form-box m-b-15">
												<div class="form-box-head text-center">
													<h4 class="title title-start-selling-box"><?php echo ('Tell Us About Your Workshop'); ?></h4>
												</div>
												<div class="form-box-body">
													...
													<div class="form-group">
														<div class="row">
															<div class="col-12 col-sm-6 m-b-15">
																<label class="control-label"><?php echo ("Workshop Name"); ?></label>
															...
															<div class="col-12 col-sm-6 m-b-15">
																<label class="control-label"><?php echo ("Workshop Category"); ?></label>
																<div class="selectdiv">
																	<select id="categories" name="shop_category_id" class="form-control" required>
																		<option value=""><?php echo trans('select_category'); ?></option>
																		<?php if (!empty($services)):
																			foreach ($services as $item): ?>
																				<option value="<?php echo html_escape($item->id); ?>"><?php echo html_escape(get_category_name_by_lang($item->id, $this->selected_lang->id)) . ' Workshop'; ?></option>
																			<?php endforeach;
																		endif; ?>
																	</select>
																</div>
													...
													<div class="form-group">
														<label class="control-label"><?php echo ("Workshop Description"); ?></label>
