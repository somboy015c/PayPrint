...
<div id="wrapper">
	<div class="container">
		...
		<div class="row">
									...
									<?php if ($general_settings->product_reviews == 1 || $general_settings->product_comments == 1 || $general_settings->facebook_comment_status == 1): ?>
										<div class="product-reviews">
											...
											<ul class="nav nav-tabs">
												...
												<?php else: ?>
													<li class="nav-item">
														<a class="nav-link active<?php echo ($general_settings->product_reviews != 1) ? 'active' : ''; ?>"
														   data-toggle="tab" href="#comments">
															<?php echo trans("comments"); ?>
														</a>
													</li>
			...
			<?php $cnt = 0; foreach ($related_products as $item){ $item = @(object)$item; $userrole = get_user($item->user_id)->role; if (!empty($item)){$cnt++;}}
			if ($cnt > 0):?>
			<div class="col-12">
				<div class="related-products">
					...
					<div class="row row-product">
							...
							foreach ($related_products as $item):
									$item = @(object)$item;
									$userrole = get_user($item->user_id)->role;
									if (!empty($item)):?>
										...
										<?php else: ?>
											<?php  if ($count < 6): ?>
													<div class="col-6 col-sm-4 col-md-3 col-lg-2 col-product">
														<?php $this->load->view('product/_product_item', ['product' => $item]); ?>
													</div>
												<?php $count++;
											endif; ?>
...
<?php $this->load->view("partials/_modal_send_message", ["subject" => $product->title, "product_id" => $product->id]); ?>
<script>
