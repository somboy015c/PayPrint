			...
			<div class="auth-box">
				<div class="row">
					<div class="col-12">
						...
						<?php endif; ?>
						<div class="form-group">
							<button type="submit" class="btn btn-md btn-custom btn-block" style="border-radius: 6px;"><?php echo trans("register"); ?></button>
						</div>
						<center><label style="padding: 15px;">Or register with:</label></center>
