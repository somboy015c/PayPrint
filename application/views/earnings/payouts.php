                ...
                <div class="row">
                    <div class="col-12 col-md-7">
                        <div class="withdraw-money-container">
                            ...
                            <div class="form-group">
                                <label><?php echo ("Withdraw From"); ?></label>
                                <div class="selectdiv">
                                    <select name="payout_from" class="form-control" required>
                                         <option value="Wallet"><?php echo ("Wallet"); ?></option>
                                         <option value="Earnings"><?php echo ("Earnings"); ?></option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="selectdiv">
                                    <select name="payout_method" class="form-control" onchange="update_payout_input(this.value);" required>
                                         <option value="ban"><?php echo ("BAN"); ?></option>
                    ...
                    <div class="col-12 col-md-5">
                        <div class="minimum-payout-container">
                            ...
                            <p><span><?php echo ("ban"); ?></span>:<strong><?php echo print_price($payment_settings->min_payout_paypal, $payment_settings->default_product_currency) ?></strong></p>
                            <?php if ($payment_settings->payout_paypal_enabled): ?>
                            ...
                            <hr>
                            <?php if (auth_check()): ?>
                                <p><?php echo ("Your Earnings Balance"); ?>:<strong><?php echo print_price(user()->balance, $payment_settings->default_product_currency) ?></strong></p>
                            <?php endif; ?>
                            <hr>
                            <?php if (auth_check()): ?>
                                <p><?php echo ("Your Wallet Balance"); ?>:<strong><?php echo print_price(user()->wallet, $payment_settings->default_product_currency) ?></strong></p>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-orders table-striped">
                            ...
                            <tr>
                                ...
                                <th scope="col"><?php echo ("Withdrew From"); ?></th>
                            ...
                            <?php foreach ($payouts as $payout): ?>
                                <tr>
                                    <td><?php if ($payout->payout_method == 'ban') { echo "BAN"; }else{ echo trans($payout->payout_method);} ?></td>
                                    <td><?php echo $payout->payout_from; ?></td>
