										...
										foreach ($order_products as $item):
											if ($item->seller_id == user()->id):
												...
												<tr>
													...
													<td>
														<strong><?php if ($item->order_status == 'order_completed') { echo "Payment Recieved"; } else { echo trans($item->order_status); }  ?></strong>
													</td>
													<td>
														<?php if ($item->product_type == 'physical') {
									...
									<div class="selectdiv">
										<select name="order_status" class="form-control order-status-select" data-order-product-id="<?php echo $item->id; ?>">
											<?php if ($item->product_type == 'physical'): ?>
												...
												<?php endif; ?>
											<?php endif; ?>
											<?php if ($order->payment_method != "Cash On Delivery" && $order->payment_method != "bank_transfer"): ?>
												<option value="payment_received" <?php echo ($item->order_status == 'payment_received') ? 'selected' : ''; ?>><?php echo trans("payment_received"); ?></option>
											<?php endif; ?>
											<?php if ($item->product_type == 'physical' && $item->order_status != 'awaiting_payment'): ?>
