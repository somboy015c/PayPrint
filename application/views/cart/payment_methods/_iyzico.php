...
<?php if ($cart_payment_method->payment_option == "iyzico"):  ?>
	...
	<?php elseif ($mds_payment_type == 'advert'):
		...
		$request->setCurrency(\Iyzipay\Model\Currency::TL);
		$request->setPaymentGroup(\Iyzipay\Model\PaymentGroup::PRODUCT);
		$request->setCallbackUrl(base_url() . "cart_controller/iyzico_payment_post?payment_type=advert&lang_base_url=" . lang_base_url());
		$request->setEnabledInstallments(array(2, 3, 6, 9));
		...
		$BasketItem = new \Iyzipay\Model\BasketItem();
		$BasketItem->setId("0");
		$BasketItem->setName($advert_plan->purchased_plan);
		$BasketItem->setCategory1("Advert Plan");
		$BasketItem->setItemType(\Iyzipay\Model\BasketItemType::PHYSICAL);
		$BasketItem->setPrice(price_format_decimal($total_amount));
		$basketItems[0] = $BasketItem;
		//cart items
	...
	<?php elseif ($mds_payment_type == 'wallet'):
		...
		$request->setCurrency(\Iyzipay\Model\Currency::TL);
		$request->setPaymentGroup(\Iyzipay\Model\PaymentGroup::PRODUCT);
		$request->setCallbackUrl(base_url() . "cart_controller/iyzico_payment_post?payment_type=wallet&lang_base_url=" . lang_base_url());
		$request->setEnabledInstallments(array(2, 3, 6, 9));
		...
		$BasketItem->setId("0");
		$BasketItem->setName($advert_plan->purchased_plan);
		$BasketItem->setCategory1("Wallet Crediting");
		$BasketItem->setItemType(\Iyzipay\Model\BasketItemType::PHYSICAL);
		$BasketItem->setPrice(price_format_decimal($total_amount));
		$basketItems[0] = $BasketItem;
		//cart items
	...
	<?php elseif ($mds_payment_type == 'store'):
		...
		$request->setCurrency(\Iyzipay\Model\Currency::TL);
		$request->setPaymentGroup(\Iyzipay\Model\PaymentGroup::PRODUCT);
		$request->setCallbackUrl(base_url() . "cart_controller/iyzico_payment_post?payment_type=store&lang_base_url=" . lang_base_url());
		$request->setEnabledInstallments(array(2, 3, 6, 9));
		...
		$BasketItem = new \Iyzipay\Model\BasketItem();
		$BasketItem->setId("0");
		$BasketItem->setName($store_plan->purchased_plan);
		$BasketItem->setCategory1("Store Plan");
		$BasketItem->setItemType(\Iyzipay\Model\BasketItemType::PHYSICAL);
		$BasketItem->setPrice(price_format_decimal($total_amount));
		$basketItems[0] = $BasketItem;
		//cart items
