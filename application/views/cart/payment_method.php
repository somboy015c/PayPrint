						...
						<div class="col-sm-12 col-lg-7">
							<div class="left">
										...
										<div class="col-12">
											<div class="form-group">
												<ul class="payment-options-list">
													<?php  if ($mds_payment_type != 'wallet'): ?>
														<li>
															<div class="option-payment">
																<div class="list-left">
																	<div class="custom-control custom-radio">
																		<input type="radio" class="custom-control-input" id="wallet" name="payment_option" value="wallet" checked required >
																		<label class="custom-control-label label-payment-option" for="wallet"><?php echo ("C-Wallet"); ?><br><small><?php echo ("Make your payment directly from your commarket Wallet."); ?></small></label>
																	</div>
																</div>
															</div>
														</li>
													<?php endif; ?>
														...
														<li>
															<div class="option-payment">
																<div class="list-left">
																	<div class="custom-control custom-radio">
																		<input type="radio" class="custom-control-input" id="earnings" name="payment_option" value="earnings" required <?php echo ($check_option == true || $mds_payment_type == 'wallet') ? 'checked' : ''; ?>>
																		<label class="custom-control-label label-payment-option" for="earnings"><?php echo ("Earnings"); ?><br><small><?php echo ("Make your payment directly from your Earnings."); ?></small></label>
																	</div>
																</div>
															</div>
														</li>
													...
													<?php if ($payment_settings->paypal_enabled): ?>
														<li>
															<div class="option-payment">
																<div class="list-left">
																	<div class="custom-control custom-radio">
																		<input type="radio" class="custom-control-input" id="option_paypal" name="payment_option" value="paypal"required <?php echo ($check_option == true) ? 'checked' : ''; ?>>
													...
													<?php if ($payment_settings->paystack_enabled): ?>
														<li>
															<div class="option-payment">
																<div class="list-left">
																	<div class="custom-control custom-radio">
													...
													<?php if ($payment_settings->razorpay_enabled): ?>
														<li>
															<div class="option-payment">
																<div class="list-left">
																	<div class="custom-control custom-radio">
													...
													<?php if ($payment_settings->pagseguro_enabled): ?>
														<li>
															<div class="option-payment">
																<div class="list-left">
																	<div class="custom-control custom-radio">
								...
								<div class="tab-checkout tab-checkout-closed-bordered">
									<h2 class="title">
										<?php if (!empty($cart_has_physical_product) && $this->form_settings->shipping == 1 && $mds_payment_type != 'promote' && $mds_payment_type != 'advert'){
											echo '3.';
										} else {
											echo '2.';
										} ?>
