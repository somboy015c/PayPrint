        ...
        <div class="row">
            <div class="col-12">
                <div class="page-confirm">
                    ...
                    <?php if ($method !="gtw" && ($method =="wallet" || $method =="earnings")): ?>
                        <h1 class="title"><?php echo trans("msg_payment_completed"); ?></h1>
                    <?php else: ?>
                        <h1 class="title"><?php echo ("Order completed successfully!"); ?></h1>
                    <?php endif; ?>
                    <?php if(!empty($transaction_number) && $method !="wallet" && $method !="earnings"): ?>
                    ...
                    <?php endif; ?>
                        <a href="<?php echo lang_base_url(); ?>cart/shipping"><label style="margin-top: 20px; border-radius: 6px;" class="btn btn-lg btn-custom float-middle"><?php echo ("View details") ?></label></a>
                </div>
            </div>
        </div>
    </div>
