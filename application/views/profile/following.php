    ...
    <div class="container" style="width: auto;">
        ...
        <div class="row"style="background-color: #f8f9fa; border-bottom-left-radius: 6px;border-bottom-right-radius: 6px; border: 4px solid #ffffff;">
            ...
            <div class="col-sm-12 col-md-9"style=" padding-top: 20px; border-radius: 6px;">
                <label class="row" style="width: 100%; background-color: #d78057 !important;margin: 0px; border-top-right-radius: 4px; border-top-left-radius: 4px; margin-bottom: 25px;"><p style="font-size: 16px; color: white; margin: 10px;">Our followings</p></label>
