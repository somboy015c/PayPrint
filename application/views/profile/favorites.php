        ...
        <div class="container" style="width: auto;">
            ...
            <div class="col-sm-12 col-md-3"style="background-color: white;">
                ...
                <div class="profile-tab-content">
                    <label class="row" style="width: 100%; background-color: #d78057 !important;margin: 0px; border-top-right-radius: 4px; border-top-left-radius: 4px; margin-bottom: 25px;"><p style="font-size: 16px; color: white; margin: 10px;">Favorites</p></label>
