            ...
            <div class="col-sm-12 col-md-9">
                <div class="row-custom">
                    <div class="profile-tab-content">
                        ...
                        <h4 class="box-title" style="padding-bottom: 10px;"><?php echo 'Update ' . trans("shipping_address"); ?></h4>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-12 col-md-6 m-b-sm-15">
                                    ...
                                    <input type="text" name="shipping_city" class="form-control form-input" value="<?php echo $user->shipping_city; ?>" placeholder="<?php echo ("City/L.G.A"); ?>" required>
                                </div>
                                <div class="col-12 col-md-6">
