...
<?php
$back_url = lang_base_url() . "settings/edit-product/" . $product->id;
        ...
        <div class="row">
            <div id="content" class="col-12">
                ...
                <?php if ($product->is_draft == 1): ?>
                    <h1 class="page-title page-title-product"><?php if (user()->role == "member") { echo trans("sell_now"); }else{ echo ("Post product"); }?></h1>
                <?php else: ?>
                        ...
                        <div class="col-12 col-md-12 col-lg-11">
                            ...
                            <div class="row">
                                <div class="col-12">
                                                ...
                                                <?php if ($product->product_type == 'physical'): ?>
                                                    <div class="form-group">
                                                        <div class="row">
                                                            ...
                                                            <?php if ($form_settings->quantity == 1 && user()->role != "member") : ?>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12 col-sm-6">
                                                            <p class="calculated-price">
                                                                ...
                                                                <?php endif; ?>
                                                                &nbsp;&nbsp;&nbsp;
                                                                <small> (<?php echo trans("commission_rate"); ?>:&nbsp;&nbsp;<?php if (user()->role == "member"){echo $general_settings->commission_rate;}else{echo "0";}  ?>%)</small>
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <?php if ($form_settings->variations == 1 && $product->product_type != 'digital' && $product->listing_type != 'ordinary_listing' && user()->role != "member"): ?>
                                        <div class="form-box">
                                            <div class="form-box-head">
                                            ...
                                            <div class="form-box-body">
                                                <div class="form-group">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12 col-sm-6 m-t-15">

                                                            <label class="control-label"><?php echo ('Delivery Range'); ?></label><p style="color: #9B9B9B;font-size: 13px;"><?php echo ('Select Delivery Range For The Above Price And Time'); ?></p>
                                                            <div class="selectdiv">
                                                                <select id="countries" name="range" class="form-control" required>
                                                                    <option value=""><?php echo ('Select delivery range'); ?></option>
                                                                    <?php if(!empty(user()->city_id)): ?>
                                                                    <option value="<?php echo 'within ' . get_city(user()->city_id)->name .' L.G.A'; ?>" <?php echo ($product->shipping_range == 'within ' . get_city(user()->city_id)->name .' L.G.A') ? 'selected' : ''; ?>><?php echo html_escape('delivery within ' . get_city(user()->city_id)->name) .' L.G.A'; ?></option>
                                                                    <?php endif; ?>
                                                                    <?php if(!empty(user()->state_id)): ?>
                                                                    <option value="<?php echo 'within ' . get_state(user()->state_id)->name .' State'; ?>" <?php echo ($product->shipping_range == 'within ' . get_state(user()->state_id)->name .' State') ? 'selected' : ''; ?>><?php echo html_escape('delivery within ' . get_state(user()->state_id)->name) .' State'; ?></option>
                                                                    <?php endif; ?>
                                                                    <?php if(!empty(user()->state_id)): ?>
                                                                    <option value="<?php echo 'within ' . get_country(user()->country_id)->name; ?>" <?php echo ($product->shipping_range == 'within ' . get_country(user()->country_id)->name) ? 'selected' : ''; ?>><?php echo html_escape('delivery within ' . get_country(user()->country_id)->name); ?></option>
                                                                    <?php endif; ?>
                                                                    <option value="<?php echo 'all over the world'; ?>" <?php echo ($product->shipping_range == "all over the world") ? 'selected' : ''; ?>><?php echo html_escape("Everywhere"); ?></option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div>
