                ...
                <div class="row" style="margin-bottom: 30px;">
                    <div class="col-sm-12 col-md-12 col-lg-6">
                        ...
                        <div class="row row-details">
                            ...
                            <div class="col-sm-8">
                                <strong class="font-right"><?php if ($order->payment_status == 'awaiting_payment' || $order->payment_status == 'payment_received') { echo trans($order->payment_status); } else {echo ($order->payment_status);} ?></strong>
                            </div>
                        </div>
                            ...
                            <table class="table table-bordered table-striped" role="grid">
                                ...
                                <?php foreach ($order_products as $item):
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <strong><?php if ($order->payment_status == 'awaiting_payment' || $order->payment_status == 'payment_received') { echo trans($order->payment_status); } else {echo ($order->payment_status);} ?></strong>
