                    ...
                    <table class="table table-bordered table-striped" role="grid">
                        ...
                        <?php foreach ($orders as $item): ?>
                            <tr>
                                ...
                                <td><strong><?php echo print_price($item->price_total, $item->price_currency); ?></strong></td>
                                ...
                                <td>
                                    <?php if ($item->payment_status == 'awaiting_payment' || $item->payment_status == 'payment_received') { echo trans($item->payment_status); } else {echo ($item->payment_status);} ?>
                                </td>
                                ...
                                <td>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu options-dropdown" style="min-width: 190px;">
                                            ...
                                            <li>
                                                <?php if ($item->payment_status != 'payment_received' && $item->payment_status != 'payment_completed'): ?>
