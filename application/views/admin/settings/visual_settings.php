		...
		<div class="box box-primary">
			...
			<div class="box-body">
				...
				<div class="form-group m-t-10">
					<label class="control-label"><?php echo trans('watermark_image') .' (Store Products, Blogs and Thumbnail)'; ?></label>
					<div class="display-block">
						<a class='btn btn-success btn-sm btn-file-upload'>
				...
				<div class="form-group m-t-10">
					<label class="control-label"><?php echo trans('watermark_image') . ' (Products For Sale)'; ?></label>
					<div class="display-block">
						<a class='btn btn-success btn-sm btn-file-upload'>
							<?php echo trans('select_image'); ?>
							<input type="file" name="forsale_watermark_image" size="40" accept=".png" onchange="$('#upload-file-info5').html($(this).val().replace(/.*[\/\\]/, ''));">
						</a>
						(.png)
					</div>
					<span class='label label-info' id="upload-file-info5"></span>
					<div style="margin-top: 10px;">
						<img src="<?php echo base_url() . $general_settings->forsale_watermark_image_large; ?>" alt="" style="max-width: 300px; max-height: 300px; background-color: #ccc;padding: 5px;">
					</div>
				</div>
