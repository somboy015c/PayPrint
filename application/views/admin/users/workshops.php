...
<div class="box">
    <div class="box-header with-border">
        <div class="left">
            <h3 class="box-title"><?php echo ('Workshops'); ?></h3>
        </div>
    </div><!-- /.box-header -->
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu options-dropdown">
                                            <li>
                                                <a href="javascript:void(0)" onclick="open_close_user_workshop(<?php echo $user->id; ?>,'Are you sure you want to close this workshop?');"><i class="fa fa-cart-plus option-icon"></i><?php echo ('Close User Workshop'); ?></a>
                                            </li>
                                            <li>
