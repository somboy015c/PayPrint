<div class="row table-filter-container">
    <div class="col-sm-12">
        ...
        <input type="hidden" name="ad_space" value="user_advert">
        ...
        <div class="item-table-filter">
            ...
            <input name="q" class="form-control" placeholder="<?php echo trans("username"); ?>" type="search" value="<?php echo html_escape($this->input->get('q', true)); ?>" <?php echo ($rtl == true) ? 'dir="rtl"' : ''; ?>>
        </div>
