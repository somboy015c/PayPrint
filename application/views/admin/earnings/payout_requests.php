                    ...
                    <table class="table table-bordered table-striped" role="grid">
                        ...
                        <?php foreach ($payout_requests as $item): ?>
                            <tr>
                                ...
                                <td>
                                    <?php if ($item->payout_method == 'ban') { echo "BAN"; }else{ echo trans($item->payout_method); }?>
                                    <p class="m-0">
                                ...
                                <td><?php echo $item->payout_from; ?></td>
                                ...
                                <td>
                                    ...
                                    <input type="hidden" name="payout_from" value="<?php echo $item->payout_from; ?>">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><?php if ($item->payout_method == 'ban') { echo "BAN"; }else{ echo trans($item->payout_method); }?></h4>
                </div>
                <div class="modal-body">
                    <?php if (!empty($payout)): ?>
                        ...
                        <?php elseif ($item->payout_method == "ban"): ?>
                            <div class="row">
                                <div class="col-sm-4">
                                    <?php echo trans("user"); ?>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    <?php $branch_country = get_country($payout->ban_bank_branch_country_id);
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    <strong>
                                        &nbsp;<?php echo $payout->ban_bank_account_holder_name; ?>
                                    </strong>
                                </div>
                            </div>
                            <div class="row">
