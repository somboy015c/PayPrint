...
<head>
    ...
    <style>
        .ntf{
            display: inline-block; font-size: 12px; background-color: #e34c5a; border-radius: 50%; top: 4px; left: 29px; height: 18px; width: 18px; line-height: 18px; text-align: center; color: #fff;font-weight: 600;
        }
    </style>
</head>
<?php
    $forsale_messages_count = $this->contact_model->get_forsale_messages_count();
    $reports_count = $this->contact_model->get_unread_reports_count();
    $unread_contact_messages = $this->contact_model->get_unread_contact_messages_count();

    $shop_reqs_count = $this->auth_model->get_shop_opening_requests_count();
    $workshop_reqs_count = $this->auth_model->get_workshop_opening_requests_count();
    $unread_transactions_count = $this->auth_model->get_unpaid_shop_opening_transactions_count();
    $users_notifications = $shop_reqs_count + $workshop_reqs_count + $unread_transactions_count;

    $payout_reqs_count = $this->earnings_admin_model->get_payout_requests_count();

    $credit_request = $this->earnings_admin_model->get_wallet_new_requests_count();

    $promotion_req = $this->transaction_model->get_promoted_requests_count();

    $pending_products_count = $this->product_admin_model->get_pending_products_count();

    $orders_count = $this->order_admin_model->get_unpaid_orders_count();
    $transactions_count = $this->transaction_model->get_unpaid_transactions_count();
    $notificatons_count = $this->order_admin_model->get_bank_transfers_notifications_count();
    $all_order = $transactions_count + $orders_count + $notificatons_count;
?>
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview">
                    <a href="#">
                        ...
                        <?php if ($all_order > 0): ?>
                            <span class="ntf"><?php echo $all_order; ?></span>
                        <?php endif; ?>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="<?php echo admin_url(); ?>orders"> <?php echo trans("orders"); ?>
                            <?php if ($orders_count > 0): ?>
                                <span class="ntf"><?php echo $orders_count; ?></span>
                            <?php endif; ?>
                        </a></li>
                        <li><a href="<?php echo admin_url(); ?>transactions"> <?php echo trans("transactions"); ?>
                        <li><a href="<?php echo admin_url(); ?>orders"> <?php echo trans("orders"); ?>
                            <?php if ($transactions_count > 0): ?>
                                <span class="ntf"><?php echo $transactions_count; ?></span>
                            <?php endif; ?>
                        </a></li>
                        <li><a href="<?php echo admin_url(); ?>order-bank-transfers"> <?php echo trans("bank_transfer_notifications"); ?>
                            <?php if ($notificatons_count > 0): ?>
                                <span class="ntf"><?php echo $notificatons_count; ?></span>
                            <?php endif; ?>
                        </a></li>
                    </ul>
                </li>
                ...
                <li class="treeview">
                    <a href="#">
                        ...
                        <?php if ($pending_products_count > 0): ?>
                            <span class="ntf"><?php echo $pending_products_count; ?></span>
                        <?php endif; ?>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="<?php echo admin_url(); ?>products"> <?php echo trans("products"); ?></a></li>
                        <li><a href="<?php echo admin_url(); ?>pending-products"> <?php echo trans("pending_products"); ?>
                        <?php if ($pending_products_count > 0): ?>
                            <span class="ntf"><?php echo $pending_products_count; ?></span>
                        <?php endif; ?>
                        </a></li>
                ...
                <li class="treeview">
                    <a href="#">
                        ...
                        <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
                        <?php if ($promotion_req > 0): ?>
                            <span class="ntf"><?php echo $promotion_req; ?></span>
                        <?php endif; ?>
                    </a>
                    <ul class="treeview-menu">
                        ...
                        <li><a href="<?php echo admin_url(); ?>promoted-products-transactions"> <?php echo trans("transactions"); ?>
                        <?php if ($promotion_req > 0): ?>
                            <span class="ntf"><?php echo $promotion_req; ?></span>
                        <?php endif; ?>
                        </a></li>
                ...
                <li class="treeview">
                    <a href="#">
                        ...
                        <span><?php echo ("Financials"); ?></span>
                        <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
                        <?php if ($credit_request > 0): ?>
                            <span class="ntf"><?php echo $credit_request; ?></span>
                        <?php endif; ?>
                    </a>
                    <ul class="treeview-menu">
                        ...
                        <li><a href="<?php echo admin_url(); ?>seller-balances?req=seller"> <?php echo ("Wallet Credit Request"); ?>
                        <?php if ($credit_request > 0): ?>
                            <span class="ntf"><?php echo $credit_request; ?></span>
                        <?php endif; ?>
                        </a></li>
                ...
                <li class="treeview">
                    <a href="#">
                        ...
                        <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
                        <?php if ($payout_reqs_count > 0): ?>
                            <span class="ntf"><?php echo $payout_reqs_count; ?></span>
                        <?php endif; ?>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="<?php echo admin_url(); ?>add-payout"> <?php echo trans("add_payout"); ?></a></li>
                        <li><a href="<?php echo admin_url(); ?>payout-requests"> <?php echo trans("payout_requests"); ?>
                        <?php if ($payout_reqs_count > 0): ?>
                            <span class="ntf"><?php echo $payout_reqs_count; ?></span>
                        <?php endif; ?>
                        </a></li>
                ...
                <li>
                    <a href="<?php echo admin_url(); ?>contact-messages">
                        ...
                        <?php if ($unread_contact_messages > 0): ?>
                            <span class="ntf"><?php echo $unread_contact_messages; ?></span>
                        <?php endif; ?>
                    </a>
                </li>
                <li>
                    <a href="<?php echo admin_url(); ?>contact-messages?type=fs">
                        <i class="fa fa-paper-plane" aria-hidden="true"></i>
                        <span><?php echo ("Forsale messages"); ?></span>
                        <?php if ($forsale_messages_count > 0): ?>
                            <span class="ntf"><?php echo $forsale_messages_count; ?></span>
                        <?php endif; ?>
                    </a>
                </li>
                <li>
                    <a href="<?php echo admin_url(); ?>contact-messages?type=report">
                        <i class="fa fa-paper-plane" aria-hidden="true"></i>
                        <span><?php echo ("Shop Reports"); ?></span>
                        <?php if ($reports_count > 0): ?>
                            <span class="ntf"><?php echo $reports_count; ?></span>
                        <?php endif; ?>
                    </a>
                </li>
                <li class="treeview">
                ...
                <li class="treeview">
                    <a href="#">
                        ...
                        <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
                        <?php if ($users_notifications > 0): ?>
                            <span class="ntf"><?php echo $users_notifications; ?></span>
                        <?php endif; ?>
                    </a>
                    <ul class="treeview-menu">
                        ...
                        <li><a href="<?php echo admin_url(); ?>administrators?data=workshops"> <?php echo ("Workshops"); ?></a></li>
                        <li><a href="<?php echo admin_url(); ?>members"> <?php echo trans("members"); ?></a></li>
                        <li><a href="<?php echo admin_url(); ?>shop-opening-requests"> <?php echo trans("shop_opening_requests"); ?>
                        <?php if ($shop_reqs_count > 0): ?>
                            <span class="ntf"><?php echo $shop_reqs_count; ?></span>
                        <?php endif; ?>
                        </a></li>
                        <li><a href="<?php echo admin_url(); ?>shop-opening-requests?ws=workshop"> <?php echo ("Workshop Opening Requests"); ?>
                        <?php if ($workshop_reqs_count > 0): ?>
                            <span class="ntf"><?php echo $workshop_reqs_count; ?></span>
                        <?php endif; ?>
                        </a></li>
                        <li><a href="<?php echo admin_url(); ?>shop-opening-requests?gp=sprqtrn"> <?php echo ("Request Transactions"); ?>
                        <?php if ($unread_transactions_count > 0): ?>
                            <span class="ntf"><?php echo $unread_transactions_count; ?></span>
                        <?php endif; ?>
                        </a></li>
                    </ul>
                </li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="<?php echo admin_url(); ?>ad-spaces"> <i class="fa fa-dollar"></i> <span><?php echo ("Admin Advert"); ?></span> </a></li>
                        <li><a href="<?php echo admin_url(); ?>ad-spaces?ad_space=user_advert"> <i class="fa fa-dollar"></i> <span><?php echo ("User Advert"); ?></span> </a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
                ...
                <li>
                    <a href="<?php echo admin_url(); ?>visual-settings?data=store">
                        <i class="fa fa-cart-plus option-icon"></i> <span><?php echo ("Store Settings"); ?></span>
                    </a>
                </li>
                <li>
                    <a href="<?php echo admin_url(); ?>visual-settings?data=advert">
                        <i class="fa fa-dollar"></i> <span><?php echo ("Advert Settings"); ?></span>
                    </a>
                </li>
                <li>
